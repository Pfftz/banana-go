    ...
    <div className="space-y-16 md:space-y-24">
      <section id="beranda" className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="text-center md:text-left" id="kontener-1">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-lg mx-auto md:mx-0"></p>
          <div className="flex flex-wrap gap-4 justify-center md:justify-start">
            <Link href="/katalog" className="bg-amber-400 text-gray-900 font-bold py-3 px-6 rounded-full text-lg hover:bg-amber-500 transition-colors duration-300 shadow-md">
              Lihat Katalog Rasa
            </Link>
            <Link href="/pemesanan" className="bg-amber-400 text-gray-900 font-bold py-3 px-6 rounded-full text-lg hover:bg-amber-500 transition-colors duration-300 shadow-md">
              Pemesanan
            </Link>
            <Link href="/kontak-testimoni" className="bg-amber-400 text-gray-900 font-bold py-3 px-6 rounded-full text-lg hover:bg-amber-500 transition-colors duration-300 shadow-md">
              Kontak & Testimoni
            </Link>
          </div>
        </div>
        ...
        <div className="relative w-full max-w-md md:max-w-full mx-auto">
          ...
          {/* Box Halal */}
          <div id="overlay-box" className="absolute bottom-4 right-4 bg-amber-400 text-gray-900 text-xs font-semibold p-2 rounded-md shadow-md">
            100% Halal <br />
            Cap Mama Gufron
          </div>

          {/* Tombol Panah Kiri */}
          <button onClick={goToPrev} aria-label="Gambar Sebelumnya" className="absolute top-1/2 left-3 -translate-y-1/2 bg-white/70 p-2 rounded-full shadow-md hover:bg-white transition-all duration-200">
          ...
          {/* Tombol Panah Kanan */}
          <button onClick={goToNext} aria-label="Gambar Berikutnya" className="absolute top-1/2 right-3 -translate-y-1/2 bg-white/70 p-2 rounded-full shadow-md hover:bg-white transition-all duration-200">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-5 h-5 text-gray-800">
          ...
          <section className="grid gap-6 sm:grid-cols-3">
            {daftarRasa.map((rasa) => (
              ...
              >
                ...
                />
                <h3 className="font-semibold text-yellow-600 text-lg">{rasa.nama}</h3>
                <p className="text-sm mt-2 text-neutral-600">{rasa.deskripsi}</p>
              </div>
            ))}
          </section>
        </div>
